...
urlpatterns = [
    ...
    path('conversations/delete', views.BulkDeleteConversationsView.as_view(), name='conversations-bulk-delete'),
    ...
    path('conversations/<int:id>/unblock', views.UnblockContactView.as_view(), name='conversation-unblock'),
