...
class ApiEndpoints {
 ...
 // static const String _base = 'http://10.0.2.2:8000/api/v1'; // virtual device
   static const String _base = 'http://localhost:8000/api/v1'; // web/local
  ...
  static String jobCommentReply(int jobId, int commentId) => '$_base/jobs/$jobId/comments/$commentId/reply';
  ...
  // __ User reviews & CV ________________________________________
  ...
  // __ Interviews _________________________________________________
  ...
  // __ Settings __________________________________________________
