...
class MessagingRemoteDataSource {
  ...
  Future<Response> blockContact(int conversationId) async {
    return await _dio.post(ApiEndpoints.userBlocked, data: {'conversation_id': conversationId});
  }

  /// DELETE /users/me/blocked/<contactId> - unblock contact.
  Future<Response> unblockContact(String contactId) async {
    return await _dio.delete(ApiEndpoints.unblockUser(contactId));
  }
