...
class NotificationsRepositoryMock implements NotificationsRepository {
  final List<NotificationEntity> _notifications = [
    ...
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 6)),
      isRead: false,
      jobTitle: 'Senior UX Designer',
    ),
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 8)),
      isRead: false,
    ...
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 10)),
      isRead: false,
...
class CandidateNotificationsRepositoryMock implements NotificationsRepository {
  final List<NotificationEntity> _notifications = [
    ...
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 1)),
      isRead: false,
      jobTitle: 'Commis de cuisine',
    ),
    // Hier — Jobs
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 3)),
      isRead: false,
      jobTitle: 'Barman',
    ),
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 5)),
      isRead: true,
      jobTitle: 'Serveur',
    ),
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 7)),
      isRead: false,
      jobTitle: 'Cuisinier',
    ),
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 9)),
      isRead: true,
    ...
    NotificationEntity(
      ...
      dateCreation: DateTime.now().subtract(const Duration(days: 1, hours: 11)),
      isRead: false,
    ),
    NotificationEntity(
      id: 'c10',
